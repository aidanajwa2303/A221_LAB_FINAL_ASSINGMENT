...
import 'package:homestayraya/models/product.dart';
                ...
                child: Column(children: [
                  ...
                  TextFormField(
                      ...
                      validator: (val) => val!.isEmpty || (val.length < 3)
                          ? "Homestay name must be longer than 3 words"
                          : null,
                  ...
                  TextFormField(
                      ...
                      validator: (val) => val!.isEmpty || (val.length < 10)
                          ? "Homestay description must be longer than 10 words"
                          : null,
                      maxLines: 4,
                      keyboardType: TextInputType.text,
                      decoration: const InputDecoration(
                    ...
                    children: [
                      ...
                      Flexible(
                        ...
                        child: TextFormField(
                            ...
                            validator: (val) => val!.isEmpty
                                ? "Quantity of person should be more than 0"
                                : null,
                            keyboardType: TextInputType.number,
                            decoration: const InputDecoration(
                                labelText: 'Quantity of Person',
                                labelStyle: TextStyle(),
