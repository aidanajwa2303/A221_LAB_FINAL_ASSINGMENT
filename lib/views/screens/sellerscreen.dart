              ...
              : Column(
                  children: [
                    Padding(
                      ...
                      child: Text(
                        "Your current services (${productList.length} found)",
                        style: const TextStyle(
  ...
  Future<void> _gotoNewProduct() async {
    if (widget.user.id == "0") {
      Fluttertoast.showToast(
          msg: "Please login/register first to get a new Homestay",
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text("Are you sure to delete?", style: TextStyle()),
          actions: <Widget>[
            TextButton(
              child: const Text(
                "Yes",
